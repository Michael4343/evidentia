...
function buildVerificationPrompt(payload: BodyPayload, claims: ClaimsPayload): string {
  ...
  lines.push(
    ...
    "",
    "CRITICAL STANCE: Assume claims are unverified until proven. Verified requires overwhelming independent evidence.",
    "Default to 'Partially Verified' unless criteria for full verification are unquestionably met.",
    "",
    "For each claim:",
    "1. Independence Check – note whether supporting evidence comes from distinct groups.",
    "2. Data Availability – highlight if underlying data/code are accessible.",
    "3. Statistical Rigor – sample sizes, controls, metrics.",
    "4. Replication – independent confirmations or contradictions.",
    "5. Methodological Soundness – design limitations or confounders.",
    "6. Contradictions – actively search for conflicting findings.",
    "",
    "Verification statuses:",
    "- Verified: 3+ independent confirmations, no contradictions, data/code available, replicated.",
    "- Partially Verified: Some support with limitations or missing replication/data.",
    "- Contradicted: Evidence refutes or methods invalid.",
    "- Insufficient Evidence: Not enough independent support to decide.",
    "",
    "Confidence levels:",
    "- High (Verified only), Moderate, Low.",
    "",
    "Document supporting and contradicting evidence for each claim with source type (Similar Paper, Research Group, Thesis, Patent) and relevance notes.",
    "Finish with a succinct overall assessment summarising claim validity across the paper."
  );
