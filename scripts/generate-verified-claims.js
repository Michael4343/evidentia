...
function buildVerificationPrompt(library) {
  ...
  lines.push(
    ...
    "1. Cross-reference against similar papers:",
    "   - Do findings support or contradict the claim?",
    "   - Are methods validated in other studies?",
    "2. Cross-reference against research groups:",
    "   - Are credible researchers working on this?",
    "   - Does group expertise validate the approach?",
    "3. Cross-reference against PhD theses:",
    "   - Do theses provide academic validation?",
    "   - Is underlying data publicly available?",
    "4. Cross-reference against patents:",
    "   - Is this novel or is there prior art?",
    "   - Do patent claims overlap technically?",
    "5. Assign verification status:",
    "   - Verified: Strong supporting evidence, no contradictions",
    "   - Partially Verified: Some support, minor gaps or contradictions",
    "   - Contradicted: Evidence refutes or undermines the claim",
    "   - Insufficient Evidence: Not enough data to verify",
    "6. Identify all supporting evidence with brief relevance notes",
    "7. Identify all contradicting evidence (if any) with brief notes",
    "8. Write 2-3 sentence verification summary explaining reasoning",
    "9. Assign confidence level (High/Moderate/Low)",
    "",
    "=== DELIVERABLE ===",
    "",
